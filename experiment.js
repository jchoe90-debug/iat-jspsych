...
timeline.push({
  ...
  stimulus: `
    <div style="max-width:820px;margin:20px auto;font-size:18px;line-height:1.7;text-align:left;">
      ...
      <p style="margin:0 0 10px;">이 연구에 참여해 주시는 경우 귀하께 <b>Extra credit</b>이 지급될 예정입니다. 단, 설문을 도중에 종료하시거나 개인식별정보(학번)를 입력하지 않으신 경우 보상이 지급되지 않습니다.</p>
...
const lastQ = participantType === "public"
  ...
  : {
      ...
      questions: [
        {
          prompt: "귀하의 학번은 무엇입니까? (학번은 2020123456 또는 20a123b56과 같이 숫자 혹은 알파벳으로 이루어진 학생 고유 번호를 의미합니다. 보상 지급 목적으로 수집되며, 답변하지 않으시는 경우 보상은 지급되지 않습니다.)",
          name: "student_id",
          required: false
        }
      ],
...
// 종료 안내 (디브리핑 포함)
timeline.push(instructions(
  `<div class="inst-card" style="max-width:760px;margin:0 auto;">
    <h2>연구 참여 완료 — 디브리핑 안내</h2>

    <p>모든 과제가 완료되었습니다. 참여해 주셔서 진심으로 감사드립니다.</p>

    <h3>이 연구의 실제 목적</h3>
    <p>연구 시작 전에 "한국 사회의 다양한 특성에 대한 인식 패턴과 평가 경향을 조사한다"고 안내드렸습니다. 그러나 이는 참여자의 반응이 연구 목적에 의해 영향받지 않도록 하기 위한 부분적 기만(partial deception)이었습니다.</p>
    <div class="info-box">
      <b>실제 연구 목적:</b> 본 연구는 <b>암묵적 연합 검사(IAT, Implicit Association Test)</b>를 사용하여, 성별(남성/여성)과 재능·노력 개념 간의 <b>무의식적 연합</b>을 측정합니다. 구체적으로, 사람들이 '재능'을 특정 성별과 더 강하게 연결 짓는 경향이 있는지를 반응 시간을 통해 파악하는 연구입니다.
    </div>
